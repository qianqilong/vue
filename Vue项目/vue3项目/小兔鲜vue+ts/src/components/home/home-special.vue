<template>
  <HomePanel title="最新专题" ref="box">
    <template v-slot:right><Globalmove /></template>
...
import type { SpecialResult } from '@/api/types'
import { ref } from 'vue'

const box = ref(null)
const SpecialList = useLazyData<Array<SpecialResult>>(box, getSpecialAPI).List
</script>
